  ...
  return (
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4">
        ...
        <div className="relative py-16 px-6 rounded-lg mb-12 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-mindexa-blue to-mindexa-purple opacity-90 rounded-lg"></div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 py-12 border-t border-gray-800">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-white transition-colors">SaaS Products</a></li>
            </ul>
          </div>
          <div>
